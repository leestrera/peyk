...
const TEMPLATES = [
  ...
  },
  {
    ...
    url: "https://yourresort.example.com"
  },
  {
    id: "vet",
    ...
    url: "https://yourvetclinic.example.com"
  },
];
...
export default function TemplatesShowcase() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-[800vh] bg-transparent z-20 -mt-[150vh]">
      <style>{`
              ...
              {template.isTitle ? (
                <div className="relative flex items-center justify-center w-[100vw] h-full">
                  ...
                  <div ref={titleTextRef} className="relative pointer-events-auto z-20 flex items-center justify-center overflow-visible">
                    <h1 className="font-heading text-6xl md:text-[150px] lg:text-[180px] font-black uppercase tracking-tighter text-white leading-none select-none flex">
